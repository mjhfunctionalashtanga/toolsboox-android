        ...
        fun onTouchEvent(
            ...
            when (motionEvent.action) {
                MotionEvent.ACTION_UP -> {
                    ...
                    // Drawn slots (see draw()): [0]=Quarter (focal), [1]=Year.
                    when (NavigatorRenderer.slotAt(px, 2)) {
                        NavigatorRenderer.ARROW_PREV -> CalendarNavigator.toQuarterPage(fragment, localDate.minusMonths(3L))
                        NavigatorRenderer.ARROW_NEXT -> CalendarNavigator.toQuarterPage(fragment, localDate.plusMonths(3L))
