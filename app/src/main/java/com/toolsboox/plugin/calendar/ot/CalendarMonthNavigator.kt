        ...
        fun onTouchEvent(
            ...
            when (motionEvent.action) {
                MotionEvent.ACTION_UP -> {
                    ...
                    // Drawn slots (see draw()): [0]=Month (focal), [1]=Quarter, [2]=Year.
                    when (NavigatorRenderer.slotAt(px, 3)) {
                        NavigatorRenderer.ARROW_PREV -> CalendarNavigator.toMonthPage(fragment, localDate.minusMonths(1L))
                        NavigatorRenderer.ARROW_NEXT -> CalendarNavigator.toMonthPage(fragment, localDate.plusMonths(1L))
