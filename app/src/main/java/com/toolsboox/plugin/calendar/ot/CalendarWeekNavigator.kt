        ...
        fun onTouchEvent(
            ...
            when (motionEvent.action) {
                MotionEvent.ACTION_UP -> {
                    ...
                    // Drawn slots (see draw()): [0]=Day, [1]=weekday, [2]=Week (focal), [3]=Month, [4]=Quarter, [5]=Year.
                    when (NavigatorRenderer.slotAt(px, 6)) {
                        NavigatorRenderer.ARROW_PREV -> CalendarNavigator.toWeekPage(fragment, localDate.minusWeeks(1L), locale)
                        NavigatorRenderer.ARROW_NEXT -> CalendarNavigator.toWeekPage(fragment, localDate.plusWeeks(1L), locale)
