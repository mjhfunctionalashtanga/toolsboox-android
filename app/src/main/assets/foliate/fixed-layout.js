// (Removed `import 'construct-style-sheets-polyfill'` — a bare npm specifier that
// doesn't resolve without a bundler; WKWebView supports constructable stylesheets
// natively, so the polyfill is unnecessary.)
